...
class ChatReadRetrieveReadApproach(Approach):
    ...
    """
    system_message_chat_conversation = """Assistant helps developers answer questions about the PSI code guidelines and development practices. Be brief in your answers.
